...
public class DialogComponentImageJDlg extends DialogComponent {
     ...
     */
    public DialogComponentImageJDlg(final SettingsModelImageJDlg model, final HarvesterModuleWrapper harvesterModule) {
        super(model);
    ...
    protected void updateComponent() {
        ...
        final SettingsModelImageJDlg model = (SettingsModelImageJDlg)getModel();
    ...
    protected void validateSettingsBeforeSave() throws InvalidSettingsException {
        ...
        for (final WidgetModel model : m_inputPanel.getWidgetModels().values()) {
            ((SettingsModelImageJDlg)getModel()).setItemValue(model.getItem().getName(), model.getValue());
        }
    }
