...
public class IntegerArrayOutputAdapter implements IJOutputAdapter<int[]> {

    @Override
    public Class<int[]> getIJType() {
        return int[].class;
    }
    ...
    @Override
    public IJOutputAdapterInstance<int[]> createAdapterInstance(final ExecutionContext exec) {

        return new IJOutputAdapterInstance<int[]>() {

            @Override
            public DataCell[] getDataCells(final int[] ijObject) {
