...
public class ImgPlusOutputAdapter implements IJOutputAdapter<ImgPlus> {
    ...
    @Override
    public IJOutputAdapterInstance<ImgPlus> createAdapterInstance(final ExecutionContext exec) {

        final ImgPlusCellFactory factory = new ImgPlusCellFactory(exec);

        return new IJOutputAdapterInstance<ImgPlus>() {

            @Override
            public DataCell[] getDataCells(final ImgPlus ijObject) {
                ImgPlusCell output = null;
                try {
                    output = factory.createCell(ijObject);
