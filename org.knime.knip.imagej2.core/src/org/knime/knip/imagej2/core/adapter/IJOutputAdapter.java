...
/**
 * Lifetime: output adapters are assumed to be singleton objects and will be created only once however the actual
...
public interface IJOutputAdapter<IJ_OBJ> extends IJAdapter<IJ_OBJ> {
     ...
     *         per execution
     */
    IJOutputAdapterInstance<IJ_OBJ> createAdapterInstance(ExecutionContext exec);
    ...
    /**
     * @return number of cells that will be created during the conversion
     */
    int getCellCount();
