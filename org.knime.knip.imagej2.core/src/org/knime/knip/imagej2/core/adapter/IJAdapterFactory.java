...
/**
 * provides an interface to add new adapters via an extension point The adapters are managed with the
 * {@link IJAdapterProvider}.
 * 
...
public interface IJAdapterFactory {
    ...
    /**
     * @return output adapters that should be registered
     */
