...
/**
 * Configures a ModuleItem of ImageJ type {@link java.lang.Character Character} with values from a user selected
 * {@link StringValue} compatible column.
 *
 *
...
public class CharacterInputAdapter extends AbstractBasicInputAdapter<Character> {
    ...
    protected void
        ...
        final String value = ((StringValue)row.getCell(columnIndex)).getStringValue();
