 ...
 */
public class ImgInputAdapter implements IJStandardInputAdapter<Img> {

    @Override
    public Class<Img> getIJType() {
        return Img.class;
    }

    @Override
    public ModuleItemDataValueConfig createModuleItemConfig(final ModuleItem<Img> item) {
        return new ModuleItemDataValueConfig() {
            ...
            public void configureModuleItem(final Module module) {
                ...
                module.setInput(item.getName(), imgPlus.getImg());
            }
