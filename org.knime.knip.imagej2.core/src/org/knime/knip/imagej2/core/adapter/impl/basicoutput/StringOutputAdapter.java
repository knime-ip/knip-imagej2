...
/**
 * Converts ImageJ output parameters of type {@link java.lang.String String} to KNIME {@link StringValue}/
 * {@link StringCell}.
 *
...
public class StringOutputAdapter implements IJOutputAdapter<String> {
    ...
    @Override
    public IJOutputAdapterInstance<String> createAdapterInstance(final ExecutionContext exec) {
        return new IJOutputAdapterInstance<String>() {

            @Override
            public DataCell[] getDataCells(final String ijObject) {
                return new DataCell[]{new StringCell(ijObject)};
            }
        };
    }
