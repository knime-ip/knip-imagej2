...
public class DoubleArrayOutputAdapter implements IJOutputAdapter<double[]> {
    ...
    @Override
    public IJOutputAdapterInstance<double[]> createAdapterInstance(final ExecutionContext exec) {

        return new IJOutputAdapterInstance<double[]>() {

            @Override
            public DataCell[] getDataCells(final double[] ijObject) {
                DoubleVectorCellFactory fac = new DoubleVectorCellFactory();
                fac.init(exec);
                return new DataCell[]{DoubleVectorCellFactory.createCell((ijObject))};
            }
        };
    }
