...
public class DataValueConfigGuiInfos {
    /**
     * label that can be presented to the user and describes the DataValue i.e. "Sigma".
     */
    public String label;

    /**
     * unique (for the executed IJ plugin) identifier for the parameter associated to the DataValue.
     */
