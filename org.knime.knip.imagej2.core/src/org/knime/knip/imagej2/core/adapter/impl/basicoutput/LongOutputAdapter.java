...
public class LongOutputAdapter implements IJOutputAdapter<Long> {
    ...
    @Override
    public IJOutputAdapterInstance<Long> createAdapterInstance(final ExecutionContext exec) {

        return new IJOutputAdapterInstance<Long>() {

            @Override
            public DataCell[] getDataCells(final Long ijObject) {
                return new DataCell[]{new LongCell(ijObject)};
            }
        };
    }
