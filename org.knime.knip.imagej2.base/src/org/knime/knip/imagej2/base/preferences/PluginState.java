    ...
    public String toString() {
        switch (m_state) {
            case ACTIVE:
                return m_name;
            case ADDING:
                return m_name + " | adding (restart required)";
            case REMOVING:
                return m_name + " | removing (restart required)";
            case UNKNOWN:
                return m_name + " | error see the log for details";
        }
        return m_name + " | something went wrong";
    }
